    ...
    <footer class="bg-white">
      <div class="max-w-screen-xl px-4 py-16 mx-auto space-y-12 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-8 pt-12 border-t border-gray-100 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <p class="font-medium text-[#9CA3AF]">Company</p>

            <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-500 font-medium">
          ...
          <div>
            <p class="font-medium text-[#9CA3AF]">Product</p>
          ...
          <div>
            <p class="font-medium text-[#9CA3AF]">Support</p>
          ...
          <div>
            <p class="font-medium text-[#9CA3AF]">Legal</p>
